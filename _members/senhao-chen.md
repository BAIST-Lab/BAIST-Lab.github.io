...
bio:
  zh: |-
    ...
    我的研究兴趣包括多模态学习、视觉—语言理解、推理与生成，以及面向基础模型的强化学习。近期研究主要围绕视觉—语言模型中的潜在视觉推理和子维度跨模态检索展开。

    我持有 USPA A 级跳伞执照，同时也是 CASI 二级单板滑雪教练、PADI 高级自由潜水员和 IKO 认证风筝冲浪者。我有一只名叫八戒的澳大利亚牧羊犬，以及一只名叫狗蛋儿的缅因猫。
  en: |-
    I am a Ph.D. student at the Harbin Institute of Technology, Shenzhen, advised by Prof. Fangyuan Zhang. I received my master’s degree in Electrical and Computer Engineering from the University of Michigan, Ann Arbor, and my B.Eng. in Automation from Zhejiang University.
